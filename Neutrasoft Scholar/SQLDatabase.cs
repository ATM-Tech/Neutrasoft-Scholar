...
namespace Neutrasoft_Scholar
{
    ...
    class SQLDatabase
    {
        ...
        private static SqlConnection GetSQLConnectionString()
        {
            ...
            SqlConnection sqlConnection = new SqlConnection("user id=NeutrasoftScholarAccess;" + "password=gNJ2EoncGpR;" + "server=madaffri.com\\BASE;" + "Integrated Security=false;" + "Database=Neutrasoft Scholar;" + "Timeout=30;");
